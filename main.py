...
with open(file="data/demma.csv", mode='r', newline='') as cvs_file:
    complete_commit_collection = list(list(zip(*csv.reader(cvs_file)))[0][1:])
    previously_collected = my_functions.get_file_names_in_path(os.path.join(root_dir, "metrics_demma"))
    ...
    gm.generate_metric_all_commits(commit_collection_to_go,
                                   ...
                                   os.path.join(root_dir, "metrics_demma"))
